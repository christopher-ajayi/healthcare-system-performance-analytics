...
OUTPUT_FILE = (
    ...
    / "raw"
    / "outcomes"
    / "30_day_stroke_mortality_raw.csv"
)
...
def main():
    ...
    print("=" * 75)
    print("CIHI — 30-DAY STROKE MORTALITY")
    ...
    # =========================================================================
    # [3] SEARCH STROKE MORTALITY INDICATORS
    # =========================================================================
    ...
    if matches.empty:
        ...
        print("\nNo stroke/mortality-related records found.")
    ...
    SELECTED_INDICATOR = "30-Day Stroke Mortality"
